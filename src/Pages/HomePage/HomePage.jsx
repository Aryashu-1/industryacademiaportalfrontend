  ...
  return (
    <div className='bg-[#f5f5f7]'>
        <div className="relative">
            <video autoPlay muted loop className="w-full h-full object-cover absolute inset-0 z-0">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-screen text-white">
                <h1 className="text-4xl font-bold mb-4">Industry-Academia Portal</h1>
                <p className="text-lg">Explore innovation and collaboration between academia and industry.</p>
            </div>
        </div>
        <div className='mt-3 mx-[70px] p-6 '>
            ...
            <div className='flex p-3'>
                ...
                <div className='w-[70%]  flex justify-center items-center'>
                    <img className='h-[400px]'  src="https://static.toiimg.com/thumb/msid-71683955,width-400,resizemode-4/71683955.jpg" alt="" />
                </div>
            ...
            <div className='flex mt-9 '>
                ...
                <div className='w-[33%] mx-2'>
                    ...
                    <br/>
                    <p className='font-mono'>These paragraphs outline the essence of our industry-academia portal, detailing our aspirations, commitments, and guiding principles that shape our operations and strategic initiatives.</p>
            ...
            <div className='mt-4' >
                ...
                <div className='flex justify-center items-center mt-7'>
                    <img className='w-[700px]' src='https://qph.cf2.quoracdn.net/main-qimg-f132d3b66b5033abf4c50c34aa2f303a-lq'/>
                </div>
            </div>
            <div className='mt-4' >
                <div className='flex justify-center items-center text-[#82001a] font-semibold text-3xl '>Research Partners</div>
                <div className='flex justify-center items-center mt-7'>
                    <img className='w-[700px]' src=' https://www.researchgate.net/publication/374021504/figure/fig2/AS:11431281189762265@1695133705385/Seven-premier-international-research-partner-institutions.png'/>
                </div>
            </div>
        </div>
