...
const InternshipCard = (props) => {
    ...
    return (
        <div onClick={()=>{navigate(`${props.internship.url}`)}} className='relative w-[700px] bg-white m-4 cursor-pointer shadow-md p-3 rounded-xl transform hover:scale-[103%] transition-transform duration-600'>
