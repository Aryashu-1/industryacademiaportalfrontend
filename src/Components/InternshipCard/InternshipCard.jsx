...
const InternshipCard = (props) => {
    ...
    return (
        <NavLink to={props.internship._id} className='relative w-[700px] mx-auto bg-white m-4 flex cursor-pointer shadow-md p-3 rounded-xl transform hover:scale-[103%] transition-transform duration-600'>
            <div>
                <img src={props.internship.urlImage} alt="ll" className='w-[200px] h-[200px] bg-gray-200 mr-3'/>
            </div>
            <div>
                ...
                {!props.internship.workFromHome && <div className='flex items-center my-2'>
                ...
                {props.internship.fullTime && <div className='flex items-center my-1'>
                    <img className='h-[14px]  mr-2' src='https://i.pinimg.com/736x/b3/cc/d5/b3ccd57b054a73af1a0d281265b54ec8.jpg'></img>
                    <h1>
                        Full Time
                </h1>
                ...
                <h1 className='mt-3'>
                    {props.internship.jobDescription}
                </h1>
